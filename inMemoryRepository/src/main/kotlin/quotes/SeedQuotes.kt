...
val seedQuotes = listOf(
    ...
    Quote(
        ...
        "William Shakespeare",
        listOfNotNull(seedTags["Shakespeare"], seedTags["Congruence"])
    ),
    Quote(
        4,
        "All the world's a stage,And all the men and women merely players",
        "William Shakespeare",
        listOfNotNull(seedTags["Shakespeare"], seedTags["No one cares"])
    ),
    Quote(
        5,
        ...
        listOfNotNull(seedTags["Dorian Grey"], seedTags["Congruence"])
    ),
    Quote(
        6,
    ...
    Quote(
        ...
        listOfNotNull(seedTags["Malazan"], seedTags["Purpose"])
    ),
    Quote(
        8,
        "Ambition is not a dirty word. Piss on compromise. Go for the throat.",
        "Gardens of the Moon - Steven Erikson",
        listOfNotNull(seedTags["Malazan"], seedTags["Inspirational"])
    ),
    Quote(
        9,
        "It is better to be hated for what you are than to be loved for what you are not",
        "Autumn Leaves - Andre Gide",
        listOfNotNull(seedTags["Congruence"])
    ),
    Quote(
        10,
        "Develop interest in life as you see it; in people, things, literature, music—the world is so rich, simply throbbing with rich treasures, beautiful souls and interesting people. Forget yourself.",
        "Henry Miller",
        listOfNotNull(seedTags["Beauty"])
    )
)
