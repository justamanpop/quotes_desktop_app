...
class InMemoryQuoteRepository : QuoteRepository {
    ...
    private var fakeQuotes = listOf<Quote>(
        Quote(
            ...
            listOfNotNull(fakeTags["Nietzsche"], fakeTags["Congruence"])
        ),
        Quote(
            2,
        ...
        Quote(
            ...
            "William Shakespeare",
            listOfNotNull(fakeTags["Shakespeare"], fakeTags["Congruence"])
        ),
        Quote(
            4,
            "All the world's a stage,And all the men and women merely players",
            "William Shakespeare",
            listOfNotNull(fakeTags["Shakespeare"], fakeTags["No one cares"])
        ),
        Quote(
            5,
            ...
            listOfNotNull(fakeTags["Dorian Grey"], fakeTags["Congruence"])
        ),
        Quote(
            6,
        ...
        Quote(
            ...
            listOfNotNull(fakeTags["Malazan"], fakeTags["Purpose"])
        ),
        Quote(
            8,
            "Ambition is not a dirty word. Piss on compromise. Go for the throat.",
            "Gardens of the Moon - Steven Erikson",
            listOfNotNull(fakeTags["Malazan"], fakeTags["Inspirational"])
        ),
        Quote(
            9,
            "It is better to be hated for what you are than to be loved for what you are not",
            "Autumn Leaves - Andre Gide",
            listOfNotNull(fakeTags["Congruence"])
        ),
        Quote(
            10,
            "Develop interest in life as you see it; in people, things, literature, music—the world is so rich, simply throbbing with rich treasures, beautiful souls and interesting people. Forget yourself.",
            "Henry Miller",
            listOfNotNull(fakeTags["Beauty"])
        )
    )
